...
export const NEG_ZERO_NODE = /* @__PURE__ */ createConstantNode(SerovalConstant.NegZero);
export const INFINITY_NODE = /* @__PURE__ */ createConstantNode(SerovalConstant.Inf);
export const NEG_INFINITY_NODE = /* @__PURE__ */ createConstantNode(SerovalConstant.NegInf);
